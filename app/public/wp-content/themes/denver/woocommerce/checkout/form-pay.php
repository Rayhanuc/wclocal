	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'denver' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'denver' ); ?></th>
			</tr>
		</thead>
		<tbody>
